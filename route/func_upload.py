...
def func_upload_2(conn):
    ...
    if flask.request.method == 'POST':
        ...
        curs.execute("insert into data (title, data, date) values (?, ?, ?)", ['파일:' + name, '[[파일:' + name + ']]\n\n[include(' + lice + ')]\n\n' + dc + '\n\n[[' + cate + ']]', get_time()])
        ...
        return easy_minify(flask.render_template(skin_check(), 
            ...
            data =  '''
                <form method="post" enctype="multipart/form-data" accept-charset="utf8">
                    파일 선택<br>
                    <input type="file" name="f_data" style="width:547.5px;height:37.5px;padding-top:5px;background:#eceeef"> <br><br>
                    파일 이름<br>
                    <input name="f_name" type="text" style="width:547.5px;height:37.5px;"> <br><br>
...
<input type="text" id="logInput" class="form-control" name="send"><br><br><p>문서 편집을 <strong>저장</strong>하면 당신은 기여한 내용을 <strong>아래에 명시된 라이선스</strong>으로 배포하고 기여한 문서에 대한 하이퍼링크나 URL을 이용하여 저작자 표시를 하는 것으로 충분하다는 데 동의하는 것입니다. 이 <strong>동의는 철회할 수 없습니다.</strong></p><br>
