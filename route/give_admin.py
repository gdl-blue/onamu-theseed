...
def give_admin_2(conn, name):
    ...
    if flask.request.method == 'POST':
        ...
        divi = '<ul><li>무권한</li>'
        rad = '(없음) <input type="radio" value="X" name="gt" onclick="document.getElementById(\'combogt\').value=\'X\';" style="width:21px" checked><br>'
